...
import {
  ContextualSentence as SchemaContextualSentence,
  SelectedContent as SchemaSelectedContent,
  DisambiguatedContent as SchemaDisambiguatedContent,
  PotentialClaim as SchemaPotentialClaim,
  ValidatedClaim as SchemaValidatedClaim,
...
/**
 * Re-export schema-defined types
 */
export type {
  VerificationResult,
  SchemaContextualSentence,
  SchemaSelectedContent,
  SchemaDisambiguatedContent,
  SchemaPotentialClaim,
  SchemaValidatedClaim,
};
